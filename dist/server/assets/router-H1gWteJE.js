...
const appCss = "/assets/styles-TkS7cHlW.css";
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "ACEXI Football Club" },
      { name: "description", content: "ACEXI Football Club" },
      { name: "author", content: "ACEXI Football Club" },
      { property: "og:title", content: "ACEXI Football Club" },
      { property: "og:description", content: "ACEXI Football Club" },
...
const $$splitComponentImporter$4 = () => import("./team-_IvKAZmA.js");
const Route$4 = createFileRoute("/team")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Meet the licensed coaches and staff behind ACE XI Football Academy."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./events-DIQ2llOY.js");
const Route$3 = createFileRoute("/events")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tournaments, leagues, and events organized by ACE XI Football Academy across Mumbai."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-CPRWMj9I.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with ACE XI Football Academy. Join our programs or ask us anything."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-coNrqMPf.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Learn about ACE XI Football Academy — Mumbai's elite football training program for youth."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DPuLAzm_.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Train like a pro at ACE XI, Mumbai's premier football academy. Licensed coaches, structured programs for U6–U16, girls' football, and competitive tournaments."
    }, {
      property: "og:title",
      content: "ACE XI Football Academy"
    }, {
      property: "og:description",
      content: "Mumbai's elite football academy. Train like a pro."
    }]
  }),
